  ...
  >
    ...
    >
      ...
      >
        ...
        >
          <v-col cols="12">
            <h1>{{ $vuetify.lang.t('$vuetify.page.BusinessStatReport.title') }}</h1>
          </v-col>
        </v-row>
        <report-viewer-component
            report-file="/reports/prt/Statistica_prepriyatii.mrt"
            :data="data"
            data-source="business-stat (3)"
        />
      </v-card-text>
    </v-card>
  </v-container>
  ...
  methods: {
    ...
    loadReportDataSet() {
      if (this.selectedCity) {
        this.$store.dispatch(reportActionType.fetchBusinessStatReportData, {
