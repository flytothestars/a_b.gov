...
const moduleName = 'IEManagerAppeal'
...
export const actionType = {
    ...
    ie_consultation_access: `[${moduleName}] ie_consultation_access`,
    ie_consultation_reject: `[${moduleName}] ie_consultation_reject`,
}
    ...
    actions: {
        [actionType.retrieveAllAppealList](context, payload) {
            return new Promise((resolve, reject) => {
                $axios
                    .get(`iemanager/appeals`, { params: payload })
                    .then(response => {
        ...
        [actionType.retrieveMyAppealList](context, payload) {
            return new Promise((resolve, reject) => {
                $axios
                    .get(`iemanager/appeals/indexByAuthUser`, { params: payload })
                    .then(response => {
        ...
        [actionType.excelExport2](context, payload) {
            ...
            return new Promise((resolve, reject) => {
                $axios
                    .get(`iemanager/appeals/exportToExcel2`, { responseType: "arraybuffer", params: payload })
                    .then(response => {
                        resolve(response.data)
                    })
                    .catch(error => {
        ...
        [actionType.retrieveAppeal](context, payload) {
            return new Promise((resolve, reject) => {
                $axios
                    .get(`iemanager/appeals/${payload.id}`)
                    .then(response => {
                        resolve(response.data.data)
                    })
                    .catch(error => {
        ...
        [actionType.ie_consultation_access](context, payload) {
            return new Promise((resolve, reject) => {
                console.log('payload', payload)
                $axios
                    .put(`iemanager/appeals/${payload.id}/access/`, payload)
        ...
        [actionType.ie_consultation_reject](context, payload) {
            console.log(payload.id)
            return new Promise((resolve, reject) => {
                console.log('payload', payload)
                $axios
                    .put(`iemanager/appeals/${payload.id}/reject/`, payload)
                    .then(response => resolve(response.data.data))
                    .catch(error => {
                        console.log(error)
                        reject(error)
        ...
        [actionType.excelExport](context, payload) {
            ...
            return new Promise((resolve, reject) => {
                $axios
                    .get(`iemanager/appeals/exportToExcel`, { responseType: "arraybuffer", params: payload })
                    .then(response => {
                        resolve(response.data)
                    })
                    .catch(error => {
        ...
        [actionType.excelExportMyAppeals](context, payload) {
            ...
            return new Promise((resolve, reject) => {
                $axios
                    .get(`iemanager/appeals/exportToExcelByAuthUser`, { responseType: "arraybuffer", params: payload })
                    .then(response => {
                        resolve(response.data)
                    })
                    .catch(error => {
        ...
        [actionType.ecxelExport](context, payload) {
            ...
            return new Promise((resolve, reject) => {
                $axios
                    .get(`iemanager/appeals/exportAppeals`, payload)
                    .then(response => {
                        resolve(response.data)
                    })
                    .catch(error => {
        ...
        [actionType.reassignDistributor](context, payload) {
            return new Promise((resolve, reject) => {
                $axios
                    .post(`iemanager/appeals/${payload.id}/reassign-distributor`, payload)
                    .then(response => {
                        resolve(response.data)
                    })
                    .catch(error => {
        ...
        [actionType.reassignDistributorMultiple](context, payload) {
            return new Promise((resolve, reject) => {
                $axios
                    .post(`iemanager/appeals/reassign-distributor`, payload)
                    .then(response => {
                        resolve(response.data)
                    })
                    .catch(error => {
