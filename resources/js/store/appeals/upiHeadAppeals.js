...
const moduleName = 'UPIHeadAppeal'
	...
	actions: {
		[actionType.retrieveAllAppealList](context, payload) {
			return new Promise((resolve, reject) => {
				$axios
					.get(`upiHead/appeals`, {params: payload})
					.then(response => {
        ...
        [actionType.retrieveMyAppealList](context, payload) {
            return new Promise((resolve, reject) => {
                $axios
                    .get(`upiHead/appeals/indexByAuthUser`, {params: payload})
                    .then(response => {
		...
		[actionType.retrieveAppeal](context, payload) {
			return new Promise((resolve, reject) => {
				$axios
					.get(`upiHead/appeals/${payload.id}`)
					.then(response => {
						resolve(response.data.data)
					})
					.catch(error => {
        ...
        [actionType.excelExport](context, payload) {
            ...
            return new Promise((resolve, reject) => {
                $axios
                    .get(`upiHead/appeals/exportToExcel`, {responseType: "arraybuffer", params: payload})
                    .then(response => {
                        resolve(response.data)
                    })
                    .catch(error => {
		...
		[actionType.ecxelExport](context, payload) {
			...
			return new Promise((resolve, reject) => {
				$axios
					.get(`upiHead/appeals/exportAppeals`, payload)
					.then(response => {
						resolve(response.data)
					})
					.catch(error => {
