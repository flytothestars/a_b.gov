<div class="mt-4 row text-center">
    <div class="">
        <div class="font-bold font-xl mt-3">
            @lang('messages.pages.service_tax.special_mobile_tax.title')
        </div>
        <div class="font-md mt-3 pt-1">
            <div class="">
                @lang('messages.pages.service_tax.special_mobile_tax.description')
            </div>
...
<div class="tab-content">
    <div id="qTextTabConditionContent" role="tabpanel" aria-labelledby="qTextTabCondition"
        ...
        @lang('messages.pages.service_tax.special_mobile_tax.content')
    </div>
</div>
