    ...
    <div class="pt-4">
        <div class="container">
            <nav aria-label="breadcrumb">
                @include('client.components.breadcrumb', ['currentLocationName'=> __('messages.pages.startBusiness.startBusiness')])
            </nav>
            <div class="row mb-5">
                <div class="col-lg-7 order-2 order-lg-1">
                    <div>
                        <div class="header">
                            @lang('messages.pages.startBusiness.startBusiness')</div>
                    </div>
                    <div class="font-md mt-4 pt-2">
                        @lang('messages.pages.startBusiness.haveAnIdeaButDontKnowWhereToStart')
                ...
                <div class="col-lg-5 order-1 order-lg-2">
                    <div class="services-img">
                        <img src="{{ asset('images/serviceGroupBanner/4.png') }}" alt="@lang('messages.pages.startBusiness.startBusiness')">
                    </div>
                </div>
