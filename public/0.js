...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      logoImg: __webpack_require__(/*! ../../assets/logo.svg */ "./resources/js/assets/logo.svg"),
      items: [{
        icon: 'mdi-newspaper',
        title: 'Контент',
        roles: ['Administrator', 'Editor', 'ChiefEditor'],
        to: '/contents'
      }, {
        icon: 'mdi-bookshelf',
        title: 'Справочники',
        ...
        [
          _c(
            ...
            [
              _c(
                "v-list-item-avatar",
                { staticClass: "align-self-center", attrs: { contain: "" } },
                [
                  _c("v-img", {
                    attrs: { src: _vm.logoImg, "max-height": "30", contain: "" }
                  })
                ],
                1
              ),
              ...
              _c(
                ...
                [
                  _c("v-list-item-title", {
                    staticClass: "headline companyName",
...
module.exports = "/images/logo.svg?902cf0210e2ab84e820314b862aff95b";
