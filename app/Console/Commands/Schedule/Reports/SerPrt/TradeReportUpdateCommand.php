...
class TradeReportUpdateCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'reports:ser-prt-trade';
    ...
    final public function handle(): int
    {
        $ratios = TaldauApiUrl
            ::where(
                ...
                IReportTypeEnum::ReportTypeTrade
            )
        ...
        foreach ($ratios as $ratio) {
            ...
            try {
                if (in_array($ratio->report_ratio_id, ITradeRatioReport::DISTRICT_REPORT_RATIOS, true)) {
