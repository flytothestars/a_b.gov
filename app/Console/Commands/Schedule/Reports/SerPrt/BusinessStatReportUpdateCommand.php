...
class BusinessStatReportUpdateCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'reports:ser-prt-business-stat-first';
    ...
    final public function handle(): int
    {
        $ratios = TaldauApiUrl
            ...
            ->whereIn(ITaldauApiUrlContract::FIELD_REPORT_RATIO_ID, IBusinessStatisticsRatioEnum::FirstPartRatios)
            ->get()
        ;
        ...
        $this->messenger->sendMessage(
            ...
            . ' _Статистика предприятий часть 1_ - Начат'
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        $this->messenger->sendMessage(
                            'Импорт данных для отчета'
                            . ' _Статистика предприятий часть 1_ - Ошибка импорта! '
        ...
        $this->messenger->sendMessage(
            'Импорт данных для отчета'
            . ' _Статистика предприятий часть 1_ - Завершен '
        );
