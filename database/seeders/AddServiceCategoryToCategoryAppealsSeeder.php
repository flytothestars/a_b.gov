...
class AddServiceCategoryToCategoryAppealsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($data as $category) {
            CategoryAppeal::query()->where('id', $category['id'])->update(['service_category_id' => $category['service_category']]);
        }
    }
}
